...
def read_data(path = 'data/data.pkl',device='cuda:0'):
    file = open(path, 'rb')
...
allseq2t,allst,idx_train,idx_val,idx_test,y,idx_train_dynamic,idx_val_dynamic,idx_test_dynamic,idx_train_static,idx_val_static,idx_test_static = read_data('data/data.pkl','cuda:0')
